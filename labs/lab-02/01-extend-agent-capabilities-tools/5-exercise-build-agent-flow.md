...
![Screenshot of insert action button highlighted in the Agent flows designer.](insert-action-button.png)
...
![Screenshot of list rows action highlighted in the Add an action pane.](list-rows-action.png)
...
![Screenshot of create connection screen for the Dataverse action.](create-connection-screen.png)

You may need to allow pop-ups for Copilot Studio to create this connection.

![Screenshot of allowing pop-ups for Copilot Studio.](allow-popups.png)
...
![Screenshot of allow access confirmation for the Dataverse connection.](allow-access-confirmation.png)
...
![Screenshot of machine Orders selected in the Table name field.](machine-orders-table.png)
...
![Screenshot of dynamic content icon highlighted with the cursor position highlighted between the single quotes.](dynamic-content-icon.png)
...
![Screenshot of dynamic content order ID.](dynamic-content-order-id.png)
...
![Screenshot of inserting a new action below the List rows action.](insert-new-action-below.png)
...
![Screenshot of selecting the Update a row Dataverse action.](update-row-dataverse-action.png)
...
![Screenshot of select the Machine Orders table for the Update a row action.](select-machine-orders-table.png)
...
![Screenshot of row ID field selected with the PowerFx.](row-id-field-powerfx.png)
...
![Screenshot of adding the expression to the Power Fx expression editor.](add-expression-powerfx.png)
...
![Screenshot of row ID expression added.](row-id-expression-added.png)
...
![Screenshot of order Status field set to the status of Canceled.](order-status-canceled.png)

Your agent flow is now ready to be published. In the top-right corner, select the **Publish** button to finalize the flow.

![Screenshot of publish button highlighted in the agent flow designer.](publish-button-flow.png)
...
![Screenshot of untitled flow highlighted in the Tools page.](untitled-flow-highlighted.png)
...
![Screenshot of name and Description provided in the flow Details section.](name-description-flow.png)
...
![Screenshot of flow Completion set to Write the response with generative AI.](flow-completion-response.png)
...
![Screenshot of order Cancellation Flow added to the agent's instructions.](order-cancellation-flow-instructions.png)
...
![Screenshot of navigating to the solutions page in Copilot Studio.](navigate-solutions-page.png)
...
![Screenshot of Machine Orders table in the Agents in a Day solution.](machine-orders-table-solution.png)
...
![Screenshot of show existing column menu with Order ID and Order Status selected.](show-existing-columns.png)

Now scroll to the right in the table to see the Order IDs. Choose one of the Order IDs you'll use for testing.

![Screenshot of list of Order IDs in the Machine Orders table.](list-order-ids.png)
...
![Screenshot of successful test of the Order Cancellation Flow.](successful-test-flow.png)
...
![Screenshot of Machine Order updated with a status of Canceled.](machine-order-canceled.png)
