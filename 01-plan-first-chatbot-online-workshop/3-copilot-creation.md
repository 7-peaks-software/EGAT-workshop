...
You'll likely be excited to get started with building an agent using Microsoft Copilot Studio. This first lab, Planning your first agent, has been written to help provide guidance on how you and your organization can get started thinking about what problems your agent can solve and where it can be deployed. We understand that you want to begin right away, however in this section you'll learn why it's important to first see what can be achieved with Generative AI in Copilot Studio as it might determine what topics you choose to manually author in the studio's authoring canvas.

## Section 1: Sign in to create an agent

Your first task is to sign in so that you can create your agent.

1. Go to https://copilotstudio.microsoft.com/ and type in your email that you'll use to build the agent. Sign in with your work, school, or developer account if you aren't working with an instructor.

       Note: 
       
       Your account might already be set up. If the following screens don't appear, skip to step 7.
