...
You can use the following scenario throughout the labs to build around your agent. You can also use your own scenarios if you prefer.
...
Contoso Coffee wants to provide customers with the ability to ask questions about their order status and delivery time and to modify their order and cancel it. This new initiative will unlock some capabilities for the call center staff and will help deflect common questions that are time-consuming on the phone, ensuring greater customer satisfaction and saving live agents' time.
