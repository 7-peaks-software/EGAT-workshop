...
![Screenshot of the Message node that will be edited.](message-node-edited.png)
...
![Screenshot of selecting the Message variation option.](message-variation-option.png)
...
![Screenshot of adding a message variation.](adding-message-variation.png)
