...
Contoso Coffee wants to provide customers with the ability to ask questions about their order status and delivery time and to modify their order and cancel it. This new initiative unlocks some capabilities for the call center staff and will help deflect common questions that are time-consuming on the phone, ensuring greater customer satisfaction and saving agents' time. Additionally, they've briefly indicated that, in B2B scenarios where they often work with other manufacturers, they want those partners to have the ability to view and ask questions about latest invoices or payments or to be escalated to live agents if they're in a specific tier of manufacturer.
...
For this module, we recommend that you first complete the following modules to get the best experience:
...
- Navigate the Generative AI settings and Conversational Boosting system topic

- Set custom prompt instructions

## Next unit: Add knowledge sources
[Continue to Add knowledge sources →](2-add-knowledge.md)
