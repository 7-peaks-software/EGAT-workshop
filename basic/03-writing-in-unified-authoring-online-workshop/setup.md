...
If you're completing this lab from the Plan your first agent module, you should've already created everything. Review the following items, and if you already have your topic built in Microsoft Copilot Studio, you can skip this task.
...
- Create a custom topic with a title and trigger phrases of your choice.
- Create a Question node within the authoring canvas in Microsoft Copilot Studio by using the User's entire response option to identify the response data.
- Create a Message node after the Question node.
- Add an End conversation node at the end of the flow.
- Save your topic and then test it by using the Test your agent option.
- Publish under the Publish site map option.

If you require guidance to complete the preceding tasks, see the Create your first agent module in this learning path, which covers the steps on how to create each item.

## Next Section

[Continue to Exercise 1: Entities in Microsoft Copilot Studio →](1-exercise-entities.md)
