...
### Next unit: Exercise - Build a basic Power Automate flow in Microsoft Copilot Studio
[Continue to Exercise - Build a basic Power Automate flow in Microsoft Copilot Studio →](3-build-flow.md)